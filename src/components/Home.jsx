      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex justify-between items-center">
          ...
          <div className="hidden lg:flex space-x-6 xl:space-x-8 items-center">
            ...
            <a href="#portfolio" className={`hover:text-orange-500 transition text-sm xl:text-base ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
              Portfolio
            </a>
            ...
            <button className="bg-orange-500 hover:bg-orange-600 px-4 xl:px-6 py-2 rounded-full font-semibold transition transform hover:scale-105 text-sm xl:text-base">
              Hire Me
            </button>
          </div>
